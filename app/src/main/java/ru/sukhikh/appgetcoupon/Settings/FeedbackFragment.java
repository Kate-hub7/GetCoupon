...
public class FeedbackFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        buttonSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url = "http://closeyoureyes.jelastic.regruhosting.ru/add-feedback";
                String message = textMessage.getText().toString();
                if (message.length()==0){
                    return;
                }
                JsonPost w = (JsonPost) new JsonPost().execute(url, message);
                Toast.makeText(getActivity(), "Отзыв отправлен", Toast.LENGTH_SHORT).show();
                getFragmentManager().popBackStack();
            }
        });
    ...
    public class JsonPost extends AsyncTask<String, String, Void> {
